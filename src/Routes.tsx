...
const Routes = ({ authenticated }: { authenticated: boolean }) => (
    ...
    <Switch>
        ...
        <AuthenticatedRoute path="/settings" exact={false} component={Settings} authenticated={authenticated} />
        ...
        <AuthenticatedRoute path="/profile/edit" exact={true} component={ProfileEdit} authenticated={authenticated} />
